...
def _local_args_to_engine_args(local: dict) -> dict:
    """Map local args to engine arg names and filter."""
...
def get_local_args():
    ...
    if local_args.get("MODEL_NAME") is None:
        logging.warning("Model name not found in /local_model_args.json.")
...
def get_engine_args():
    ...
    # Auto-discover engine args from env
    ...
    # Special conversion for limit_mm_per_prompt
    ...
    # Auto tensor parallel if multiple GPUs
